...
export const app = new Elysia()
  ...
  .get("/stats/barttorvik", async ({ cache, cacheKey, status, set }) => {
    // Manually set headers for these top-level routes

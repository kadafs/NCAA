...
print("Grading Top-Down Projection across all available MLB reports...\n")
...
for report in reports:
    ...
    # Run the grader
    try:
        output = subprocess.check_output(['python', 'mlb/grade_td_reports.py', '--file', report, '--date', date_str, '--td'], universal_newlines=True, stderr=subprocess.STDOUT)
...
print("\n" + "="*40)
print("TOP-DOWN PROJECTION HISTORICAL RECORD")
print("="*40)
for r in results:
    print(r)
print("-" * 40)

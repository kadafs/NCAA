...
## 🚨 TOP PRIORITY GAMES 🚨
- **Pericos de Puebla @ Diablos Rojos del Mexico:** ENV CONFIRM (delta=+8)
...
2. **Guerreros de Oaxaca @ Piratas de Campeche** ──► **BET F5 OVER** (Odds: 1.85)
    *   *System Note:* Divergent baseline alignment confirms line value. Trusting TD via pure distance edge.

3. **Guerreros de Oaxaca @ Piratas de Campeche** ──► **BET F5 OVER** (Odds: 1.85)
    *   *System Note:* Divergent baseline alignment confirms line value. Trusting TD via pure distance edge.

4. **Rieleros de Aguascalientes @ Sultanes de Monterrey** ──► **BET F5 OVER** (Odds: 1.85)
    *   *System Note:* Divergent baseline alignment confirms line value. Trusting TD via pure distance edge.

5. **Algodoneros Union Laguna @ Tecos de los Dos Laredos** ──► **BET F5 OVER** (Odds: 1.85)
    *   *System Note:* Divergent baseline alignment confirms line value. Trusting TD via pure distance edge.

6. **Leones de Yucatan @ Bravos de Leon** ──► **BET F5 OVER** (Odds: 1.85)
    *   *System Note:* Divergent baseline alignment confirms line value. Trusting TD via pure distance edge.

7. **Saraperos de Saltillo @ Charros de Jalisco** ──► **BET F5 OVER** (Odds: 1.85)
    *   *System Note:* Divergent baseline alignment confirms line value. Trusting TD via pure distance edge.

8. **Conspiradores de Queretaro @ El Aguila de Veracruz** ──► **BET F5 OVER** (Odds: 1.85)
    *   *System Note:* Divergent baseline alignment confirms line value. Trusting TD via pure distance edge.

9. **Tigres de Quintana Roo @ Olmecas de Tabasco** ──► **BET F5 OVER** (Odds: 1.85)
    *   *System Note:* Divergent baseline alignment confirms line value. Trusting TD via pure distance edge.

10. **Toros de Tijuana @ Dorados de Chihuahua** ──► **BET F5 OVER** (Odds: 1.85)
    *   *System Note:* Divergent baseline alignment confirms line value. Trusting TD via pure distance edge.

11. **Caliente de Durango @ Acereros del Norte** ──► **BET F5 OVER** (Odds: 1.85)
    *   *System Note:* Divergent baseline alignment confirms line value. Trusting TD via pure distance edge.


---

### 🚨 Pericos de Puebla (TBD) @ Diablos Rojos del Mexico (TBD)
...
- **Monte Carlo Simulated F5 Total:** 4.67 Runs (Lineups: Projected (Generic))
...
### Guerreros de Oaxaca (TBD) @ Piratas de Campeche (TBD)
...
- **Monte Carlo Simulated F5 Total:** 4.57 Runs (Lineups: Projected (Generic))
...
### Rieleros de Aguascalientes (TBD) @ Sultanes de Monterrey (TBD)
...
### Algodoneros Union Laguna (TBD) @ Tecos de los Dos Laredos (TBD)
🏙️ **Uni-Trade Stadium** (Park Factor: 1.0x)
🌤️ **Weather:** 98F | 16 MPH L-R | Weather: +4.2%
...
### Tigres de Quintana Roo (TBD) @ Olmecas de Tabasco (TBD)
...
### Toros de Tijuana (TBD) @ Dorados de Chihuahua (TBD)
🏙️ **Estadio Chihuahua** (Park Factor: 1.0x)
🌤️ **Weather:** 72F | Calm | Weather: +0.3%
🌍 **ENV Filters:** All NEUTRAL — pure talent drives the projection
- **Pitcher Matchup:** TBD (RHP, SIERA: 4.5) vs TBD (RHP, SIERA: 4.5)
- **Top-Down Projected F5 Total:** 5.35 Runs
- **Monte Carlo Simulated F5 Total:** 4.64 Runs (Lineups: Projected (Generic))
- **Monte Carlo Late Innings (6-9):** 3.51 Runs (Away BP FIP: 4.5 | Home BP FIP: 4.5)
- **Monte Carlo FULL GAME Total:** 8.15 Runs
- **Full Game Probs:** Over 7.5: 56% | Over 8.5: 42% | Over 9.5: 30%

### Caliente de Durango (TBD) @ Acereros del Norte (TBD)
🏙️ **Estadio Kickapoo Lucky Eagle** (Park Factor: 1.0x)
🌤️ **Weather:** 94F | 14 MPH In | Weather: -0.6%
